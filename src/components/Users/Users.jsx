...
let Users = (props) => {
    ...
    return (<div className={s.users}>
        ...
        {props.users.map(u => <div key={u.id} className={s.user} >
            <NavLink to={`/users/${u.id}`}>< img onClick={() => { props.setCurrentUserId(u.id) }} src={u.photos.small != null ? u.photos.small != null : "https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/Face-smile.svg/1024px-Face-smile.svg.png"} alt="" className={s.imgUser} />
            </NavLink>
